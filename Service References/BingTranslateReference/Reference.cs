...
namespace nppTranslateCS.BingTranslateReference {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private nppTranslateCS.BingTranslateReference.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public nppTranslateCS.BingTranslateReference.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="BingTranslateReference.LanguageService")]
    public interface LanguageService {
        ...
        nppTranslateCS.BingTranslateReference.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, nppTranslateCS.BingTranslateReference.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, nppTranslateCS.BingTranslateReference.Translation[] translations, string from, string to, nppTranslateCS.BingTranslateReference.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        nppTranslateCS.BingTranslateReference.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, nppTranslateCS.BingTranslateReference.TranslateOptions options);
        ...
        nppTranslateCS.BingTranslateReference.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, nppTranslateCS.BingTranslateReference.TranslateOptions options);
        ...
        nppTranslateCS.BingTranslateReference.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, nppTranslateCS.BingTranslateReference.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : nppTranslateCS.BingTranslateReference.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<nppTranslateCS.BingTranslateReference.LanguageService>, nppTranslateCS.BingTranslateReference.LanguageService {
        ...
        public nppTranslateCS.BingTranslateReference.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, nppTranslateCS.BingTranslateReference.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, nppTranslateCS.BingTranslateReference.Translation[] translations, string from, string to, nppTranslateCS.BingTranslateReference.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public nppTranslateCS.BingTranslateReference.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, nppTranslateCS.BingTranslateReference.TranslateOptions options) {
        ...
        public nppTranslateCS.BingTranslateReference.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, nppTranslateCS.BingTranslateReference.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public nppTranslateCS.BingTranslateReference.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, nppTranslateCS.BingTranslateReference.TranslateOptions options) {
