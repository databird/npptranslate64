...
namespace NppPluginNET
{
    ...
    {
        public Sci_CharacterRange(int cpmin, int cpmax) { cpMin = new IntPtr(cpmin); cpMax = new IntPtr(cpmax); }
        public IntPtr cpMin;
        public IntPtr cpMax;
    }
    ...
    public class Win32
    {
        ...
        [DllImport("kernel32")]
        public static extern int GetPrivateProfileString(string lpAppName, string lpKeyName, string strDefault, StringBuilder retVal, int size, string lpFileName);
        [DllImport("kernel32")]
